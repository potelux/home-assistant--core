...
class JellyfinDataUpdateCoordinator(DataUpdateCoordinator[dict[str, dict[str, Any]]]):
    ...
    def __init__(
        ...
        # Tracks all devices ever seen, keyed by device_id. Persisted across restarts.
    ...
    async def _async_update_data(self) -> dict[str, dict[str, Any]]:
        ...
        for session in sessions:
            ...
            self.known_devices[device_id] = _device_info_from_session(session)
            self.session_device_map[session["Id"]] = device_id
